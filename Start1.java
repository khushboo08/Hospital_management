...
import javax.swing.*;
class Start1 extends JFrame implements ActionListener
{
...
setIconImage(icon);
setLayout(null);
lbl=new JLabel("Patient's information");
lbl.setBounds(445,30,210,20);
lbl1=new JLabel("1.Add patients information");
lbl1.setBounds(200,150,210,20);
lbl2=new JLabel("2.Modify patients information");
lbl2.setBounds(200,250,210,20);
lbl3=new JLabel("3.View patients information");
